...
```
In this case, 41% of the test observations are misclassified. The non-linear decision boundary from the SVM outperformed the SVC with the linear boundary, which is expected because the data itself is non-linear.